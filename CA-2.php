...
<html lang="en">
  <head>
    ...
    <title>Money business Account</title>
    <link
  ...
  <body>
    ...
    <div class="img-section">
      <img src=" ./images/CA-2-hero.jpg" class="fd w-100" alt="..." />
    </div>
    <!--  -->
    <div class="container mt-4">
      <h3>SMART Money Business Account</h3>
      <div class="mt-3">
        SMART Money Business Account is designed and customized for your
        business needs. Our innovative Sweep Facility ensures that cash in your
        account is invested to multiply your otherwise idle funds.
      </div>
      <div class="mt-3">
        With comprehensive digital solutions, SMART Money Business Account is
        seamless solution to manage your cash, while earning hassle-free
        returns. In addition, you will also get facilities like virtual
        accounts, a payment gateway service and High Cash Deposit Limit per
        month.
      </div>
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <ul>
                ...
                <li>Threshold amount - ₹ 20,00,000/-</li>
          ...
          <tr>
            ...
            <td>
              <ul>
                <li>No charge upto ₹ 50,00,000 per month</li>
              </ul>
            </td>
          </tr>
        </tbody>
      ...
      <div class="mt-3">
        Both new and existing customers of ENB Bank can have a SMART Money
        Business Account
      </div>
